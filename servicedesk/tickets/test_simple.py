...
class SimpleTicketTest(TestCase):
    ...
    def test_operator_message_creation(self):
        ...
        self.assertEqual(operator_message.text, 'Здравствуйте! Мы получили ваше обращение и работаем над решением.')
        self.assertFalse(operator_message.is_from_user)  # Проверяем, что это НЕ от пользователя
